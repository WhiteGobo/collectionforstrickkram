...
def call_function( stitchdata, mymesh ):
    updist = mymesh.surfacemesh.uplengtharray
    downdist = mymesh.surfacemesh.downlengtharray
    leftdist = mymesh.surfacemesh.leftlengtharray
    rightdist = mymesh.surfacemesh.rightlengtharray

    uplength = abs( updist[0] - updist[-1] )
    downlength = abs( downdist[0] - downdist[-1] )
    rightlength = abs( rightdist[0] - rightdist[-1] )
    leftlength = abs( leftdist[0] - leftdist[-1] )
